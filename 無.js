...
function videoZVV(name) { 
  str = '<iframe frameborder="0" height="800" marginheight="0" marginwidth="0" scrolling="no" src="https://googledrive.com/host/0B8QlaU9AmBqDfi1zejU2TXluSjJUYkhlWkg2Zm5QZmY3ZExtaW1uWXNRR1VxeEowTzFwWGc/'+name+'.html" width="100%" allowfullscreen></iframe>';
  return str;
}
